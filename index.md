...
While I was telling myself and everyone else that I was only going to be there for a two-year Master's in Language Technology, it's been over 6 years and I'm still here: after graduation and a short but fun time working as a software developer at [Digital Grammars](https://www.digitalgrammars.com/), I embarked in the longer-term project of a PhD in Natural Language Processing at [Språkbanken Text](https://spraakbanken.gu.se/), where I work at the intersection between Computational Syntax and Second Language Acquisition.
