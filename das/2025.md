...
{% include image.html file="../assets/img/das/cc-home.png" description="WIP homepage; styling inspired by htop." %}

{% include image.html file="../assets/img/das/cc-recipe.png" description="Very WIP recipe page; styling inspired by command-line Markdown previewers such as glow." %}
...
| My favorite photo from the July Adventure |
| --- |
...
| ![Silhouette of a little bird standing on the top of our tent seen from the inside of a tent](../assets/img/ctc/6-bird.JPG) |
| --- |
| My favorite photo from the July Adventure, but this time the caption is underneath |
