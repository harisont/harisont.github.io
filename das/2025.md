...
All I managed to do was to update my nerdy [RAQs about Swedish syntax in the Universal Dependencies framework](../lists/svud-raq.md#vad-adj) (which is kind of a time consuming side effect of the annotation work) and start a music listening diary for this transition phase from Spotify to I don't know yet what.
