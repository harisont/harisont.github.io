...
{% include image.html file="../assets/img/das/cc-home.png" description="WIP Concurrent Cooking homepage; styling inspired by htop." %}

{% include image.html file="../assets/img/das/cc-recipe.png" description="Very WIP Concurrent Cooking recipe page; styling inspired by command-line Markdown previewers such as glow." %}
...
- I implemented the UI elements (but not the underlying functionality) for hiding/displaying (un)wanted linguistic features in wytiwys:
  ![A dependency tree for the sentence "What You See Is Just Part Of What You Get". Right above it there is a row of checkboxes to select which linguistic features to display](../assets/img/das/wysijpowyg.png)
