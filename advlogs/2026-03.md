...
If I happen to exceed my own (reduced) expectations and do anything, however small, beyond the ominous must-do list, I'll take note of that in this log. 

## Monday[^1]
- created [a Codeberg account](https://codeberg.org/harisont). The plan is not to quit GitHub quite yet, but to gradually move the bulk of my code (personal projects at the very least) somewhere better
