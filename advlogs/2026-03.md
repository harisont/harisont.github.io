...
#### Sunday
- _successfully_ installed Debian (btw) on the ~~server~~ half broken laptop and sshd into it from my ~~mainframe~~ other half broken laptop (guess I can say "I use Debian btw" now?)
- went on a nice short bike ride with a friend. We went to a nearby lake, Aspen. While there, we tried to fix my front gear, which had completely stopped working. It's much better now, but still need some adjusting. Luckily, the ride there and back is very flat and it wasn't really needed
  
  ![A yellow GPS track in the FOSS app CoMaps. It goes from east Gothenburg to the lake Aspen in Jonsered and back, taking slightly different routes in some places](../assets/img/varvinterventure/jonsered.jpg)
